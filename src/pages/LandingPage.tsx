        ...
        <div className="container relative mx-auto px-4 sm:px-6">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white" onClick={handleScrollToTools}>
                Explore Tools <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
              
              <Button variant="outline" size="lg" className="w-full sm:w-auto border-blue-500 text-blue-400 hover:bg-blue-950" asChild>
          ...
          <div className="flex justify-center mb-8">
            <div className="grid grid-cols-2 gap-4 max-w-lg">
              ...
              <Link to="/image-to-prompt" className="group relative overflow-hidden rounded-xl bg-gray-900 border border-gray-800 hover:border-pink-500 transition-all duration-300 p-8 flex flex-col items-center justify-center text-center">
      ...
      <section ref={toolsRef} className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {/* Current Tools */}
            <ToolCard icon={<Wand2 className="h-10 w-10 text-purple-400" />} title="Image Generator" description="Create images from text descriptions" link="/image-generator" color="from-purple-600 to-blue-600" number="1" />
            
            <ToolCard icon={<MessageSquareText className="h-10 w-10 text-pink-400" />} title="Image to Prompt" description="Convert images to text prompts" link="/image-to-prompt" color="from-pink-600 to-purple-600" number="2" />
            
            <ToolCard icon={<Zap className="h-10 w-10 text-amber-400" />} title="Image Upscaler" description="Enhance image resolution" link="/image-upscaler" color="from-amber-600 to-yellow-600" number="3" />
            
            <ToolCard icon={<Layers className="h-10 w-10 text-cyan-400" />} title="Metadata Generator" description="Extract image metadata" link="/metadata-generator" color="from-cyan-600 to-blue-600" number="4" />
            
            {/* Upcoming Tools */}
            <ToolCard icon={<Palette className="h-10 w-10 text-green-400" />} title="Graphic Designer Bot" description="AI-powered design assistant" link="/graphic-designer-bot" color="from-green-600 to-emerald-600" isUpcoming={true} number="5" />
            
            <ToolCard icon={<Download className="h-10 w-10 text-rose-400" />} title="Bulk Image Tool" description="Process multiple images at once" link="/bulk-image-size-increaser" color="from-rose-600 to-red-600" isUpcoming={true} number="6" />
          </div>
        </div>
      </section>
      ...
      <section ref={featuresRef} className="py-20 bg-gray-950">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard icon={<Sparkles className="h-7 w-7 text-purple-400" />} title="High-Quality Results" description="Generate stunning, high-resolution images with amazing detail and clarity." />
            <FeatureCard icon={<Zap className="h-7 w-7 text-amber-400" />} title="Lightning Fast" description="Get your images in seconds, not minutes. Our optimized AI models deliver quick results." />
            <FeatureCard icon={<Shield className="h-7 w-7 text-green-400" />} title="Free to Use" description="Start creating beautiful designs without any commitment. Upgrade anytime for additional features." />
            <FeatureCard icon={<Download className="h-7 w-7 text-blue-400" />} title="Easy Downloads" description="Download your creations with one click. Use them for any project or purpose." />
            <FeatureCard icon={<Image className="h-7 w-7 text-cyan-400" />} title="Wide Range of Styles" description="From photorealistic to artistic, create images in any style imaginable." />
            <FeatureCard icon={<Clock className="h-7 w-7 text-pink-400" />} title="Save Time" description="Accomplish in minutes what would take hours with traditional design tools." />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-purple-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            {!user && <Button variant="outline" size="lg" className="border-white text-white hover:bg-white/10" asChild>
                <Link to="/auth">
                  Sign Up Free
                </Link>
              </Button>}
...
const ToolCard = ({
  ...
  return <div className="relative group">
      {isUpcoming && <div className="absolute -top-2 -right-2 z-10 bg-amber-500 text-xs font-bold text-white rounded-full px-2 py-1">
          UPCOMING
        </div>}
      ...
      <Link to={link} className={`block h-full bg-gray-800 hover:bg-gray-750 rounded-xl p-6 transition-all duration-300 border-t-2 border-transparent hover:border-t-2 hover:border-${color.split(' ')[0].substring(5)} overflow-hidden`}>
...
const FeatureCard = ({
  ...
  return <div className="bg-gray-900/80 hover:bg-gray-800 rounded-xl p-6 transition-all duration-300 border border-gray-800 hover:border-gray-700">
